...
@section('content')
	...
	<form method="post" action="/admin/exame/categorie/store" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" value="{{old('name')}}" placeholder="Ex: 10ª classe,12ª classe, Admição" name="name" class="form-control" required="true">
